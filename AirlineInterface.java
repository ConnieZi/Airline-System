...
public interface AirlineInterface {
   ...
   * @return a (possibly empty) Set<ArrayList<String>> of fewest-stops pathes.
   ...
   * @param source the String source city name
   * @param destination the String destination city name
   * @return a (possibly empty) Set<ArrayList<String>> of shortest-distance
   * pathes. Each path is an ArrayList<Route> of Route objects that includes a
   ...
   * pathes. Each path is an ArrayList<Route> of city names that includes
